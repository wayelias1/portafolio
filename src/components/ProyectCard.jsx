...
export function ProyectCard ({titulo, imagen, descripcion, children, link, boton, tipo}){
    ...
    return (
        <article className='flex flex-col relative h-full rounded-lg shadow-lg px-6 md:px-12 py-12 border bg-slate-100 border-gray-300 dark:bg-slate-900 dark:border-gray-800 dark:shadow-gray-800 dark:text-white transition md:hover:scale-105'>
          <div className={claseProyecto} ><p className="text-blue-700 dark:text-blue-200">Real Project</p></div>
          ...
          <h4 className='text-xl font-bold dark:text-blue-300 text-blue-800'>{titulo}</h4>
